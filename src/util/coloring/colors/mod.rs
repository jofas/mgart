...
impl RGB {
    ...
    fn lab(self) -> LAB {
        ...
        let x = Self::xyz_lab((0.412_456_4 * r + 0.357_576_1 * g + 0.180_437_5 * b) / LAB::XN);
        let y = Self::xyz_lab((0.212_672_9 * r + 0.715_152_2 * g + 0.072_175_0 * b) / LAB::YN);
        let z = Self::xyz_lab((0.019_333_9 * r + 0.119_192_0 * g + 0.950_304_1 * b) / LAB::ZN);
...
impl LAB {
    ...
    fn rgb(&self) -> RGB {
        ...
        let r = Self::xyz_rgb(3.240_454_2 * x - 1.537_138_5 * y - 0.498_531_4 * z);
        let g = Self::xyz_rgb(-0.969_266_0 * x + 1.876_010_8 * y + 0.041_556_0 * z);
        let b = Self::xyz_rgb(0.055_643_4 * x - 0.204_025_9 * y + 1.057_225_2 * z);
...
mod test {
    ...
    fn rgb2lab() {
        ...
        assert_eq!(GREEN_RGB.lab().round(2), LAB::new(87.73, -86.18, 83.18));
        assert_eq!(CYAN_RGB.lab().round(2), CYAN_LAB);
        assert_eq!(BLUE_RGB.lab().round(2), LAB::new(32.3, 79.19, -107.86));
        assert_eq!(MAGENTA_RGB.lab().round(2), LAB::new(60.32, 98.23, -60.82));
    }
    ...
    fn rgb2lch() {
        ...
        assert_eq!(CYAN_RGB.lch().round(2), LCH::new(91.11, 50.12, 196.38));
